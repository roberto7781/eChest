  ...
  <!-- Modal -->
  <div class="modal fade" id="form_location" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <form id="location_form" onsubmit="return false">
          <div class="form-group">
            ...
            <small id="locationError" class="form-text text-muted"></small>
          </div>
